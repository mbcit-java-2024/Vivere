	...
	<div class="body-main">
		<div class="main">
			<form action="/bookOK" method="post" onsubmit="return submitAction()">
				...
				<div style="display: flex; border: none; padding: 0; margin: 10px 0px 80px; width: 910px;">
					<input class="button" type="button" value="뒤로가기" onclick="history.back()"/>&nbsp;
					<input class="button btn-pay" type="submit" value="결제하기" onclick="bookNow()"/>
				</div>
			</form>
		</div>
	</div>
