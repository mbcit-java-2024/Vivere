...
public class ConcertController {
   ...
   public String insertConcertOK(@RequestParam("imageUrl") MultipartFile file,
         ...
         @RequestParam("vipSeats") Optional<String[]> vipSeats, @RequestParam("rSeats") Optional<String[]> rSeats,
         @RequestParam("sSeats") Optional<String[]> sSeats, @RequestParam("aSeats") Optional<String[]> aSeats) {
...
//      jsp 로 필요한 정보 보내기
   ...
   public String updateConcertOK(@RequestParam("imageUrlUpdate") MultipartFile file,
         @RequestParam("concertId") String concertId, @RequestParam("isSeatTypeChange") boolean isSeatTypeChange,
         @RequestParam("concertDateTime") String[] concertDateTimes, ConcertVO concertVO, HttpServletRequest request,
         @RequestParam("vipSeats") Optional<String[]> vipSeats, @RequestParam("rSeats") Optional<String[]> rSeats,
         @RequestParam("sSeats") Optional<String[]> sSeats, @RequestParam("aSeats") Optional<String[]> aSeats) {
...
//   등급별 좌석 정보 넘겨주기
   ...
   @ResponseBody
   public String getSelectedSeats(@RequestParam("seatType") String seatType,
...
//   콘서트 타임 1건 추가
   ...
   @ResponseBody
   public Map<String, Object> addConcertTime(@RequestParam("concertId") int concertId,
